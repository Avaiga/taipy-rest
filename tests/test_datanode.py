...
def test_get_datanode(client, default_datanode):
    ...
    with mock.patch("taipy.core.data.data_manager.DataManager._get") as manager_mock:
...
def test_delete_datanode(client):
    ...
    with mock.patch("taipy.core.data.data_manager.DataManager._delete"):
        # test get_datanode
...
def test_read_datanode(client, default_df_datanode):
    with mock.patch("taipy.core.data.data_manager.DataManager._get") as config_mock:
